...
CREATE TABLE IF NOT EXISTS sites (
  ...
  category VARCHAR(20) CHECK (category IN ('nature', 'culture', 'adventure', 'relaxation', 'mountain', 'beach', 'other')) DEFAULT 'other',
...
CREATE INDEX IF NOT EXISTS idx_ratings_site ON ratings(site_id);
