...
const { getSites, createSite, rateSite, getSiteDetail, likeSite, unlikeSite, getSitesFeed } = require('../controllers/sitesController');

router.get('/', optionalAuth, getSites);
router.post('/', verifyToken, createSite);
router.get('/feed', optionalAuth, getSitesFeed);
